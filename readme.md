...
This module was inspired from the very well thought out Laraval-Breadcrumbs(https://github.com/diglactic/laravel-breadcrumbs) package. This module is not a port of that package. It was designed to bring similar breadcrumb functionality to ColdBox.
